...
class Config:
    ...
    ####NEW MCP GENERATED BY THE SYSTEM#####
    MCP_KAFKA_CONFLUENT_URL = os.getenv("MCP_KAFKA_CONFLUENT_URL", "http://kafka_confluent-mcp-service:9100/mcp")
    ...
    if MCP_MODE == "http":
        # HTTP Mode
        for url in [MCP_HTTP_URL, MCP_OPCUA_URL, MCP_MONGO_URL, MCP_DOCKER_URL, MCP_GRAFANA_URL, MCP_KAFKA_CONFLUENT_URL]:  ##MCP_KAFKA_URL
            if url :
